$(document).ready(function() {
  $.simpleWeather({
    ...
    success: function(weather) {
      ...
      $("#forecast-1 > .temps").html('Low: '+weather.forecast[3].low+' / High: '+weather.forecast[1].high);
      $("#forecast-2 > .temps").html('Low: '+weather.forecast[3].low+'/ High: '+weather.forecast[2].high);
      $("#forecast-3 > .temps").html('Low: '+weather.forecast[3].low+' / High: '+weather.forecast[3].high);
      $("#forecast-4 > .temps").html('Low: '+weather.forecast[3].low+' / High: '+weather.forecast[4].high);
